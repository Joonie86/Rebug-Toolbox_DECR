...
#define HVSC_SYSCALL_ADDR_315		0x80000000001C2844ULL	// where above syscall is in lv2 3.15 DEH
...
#define HVSC_SYSCALL_ADDR_475D		0x80000000002D226CULL	// where above syscall is in lv2 4.75, 4.76, 4.78 DEX
...
#define NEW_POKE_SYSCALL_ADDR_315	0x80000000001C2D6CULL	// where above syscall is in lv2 3.15 DEH
...
#define NEW_POKE_SYSCALL_ADDR_475D	0x80000000002D2794ULL   // where above syscall is in lv2 4.75 , 4.76, 4.78 DEX
...
#define SYSCALL_TABLE_315			0x8000000000332C38ULL	// 3.15 DEH
...
#define SYSCALL_TABLE_475D			0x80000000003B28F8ULL	// 4.75 DEX , TOC : 3758E0
#define SYSCALL_TABLE_476			0x8000000000363BE0ULL	// 4.76
#define SYSCALL_TABLE_476D			0x80000000003B28F8ULL	// 4.76 DEX , TOC : 3758E0
...
#define	HV_START_OFFSET2_455		0x177A68    			// set lv2 access rights for sys_storage
/*
// 4.60 
